...
pdb_dir = '/home/ubuntu/CIRPIN/cpdb_comparison/foldseek_CPDB_comparison/cpdb_pdbs_2/CPDB_constraint_filtered'

# Output directory for results
output_base_dir = '/home/ubuntu/CIRPIN/cpdb_comparison/foldseek_CPDB_comparison/cpdb_pdbs_2/CPDB_constraint_filtered/parameter_sweep_results'
os.makedirs(output_base_dir, exist_ok=True)

tmp_dir = '/home/ubuntu/CIRPIN/cpdb_comparison/foldseek_CPDB_comparison/cpdb_pdbs_2/CPDB_constraint_filtered/tmp'
...
cluster_modes = [0, 1, 2]  # 0: Set-Cover, 1: Connected component, 2: CDHIT

# Labels for clarity
alignment_labels = {0: '3di', 1: 'TM', 2: '3Di+AA'}
cluster_labels = {0: 'SetCover', 1: 'ConnectedComp', 2: 'CDHIT'}
...
for align_type in alignment_types:
    for clust_mode in cluster_modes:
        ...
        try:
            ...
            print(f"ERROR: foldseek command not found!")
            print(f"Make sure you've activated the foldseek conda environment")
            ...
            results.append({
                ...
                'num_clusters': 'FOLDSEEK_NOT_FOUND',
            ...
            print(f"Error running foldseek!")
